...
- **세밀한 표시 커스터마이징**  
  설정창 라이트 / 다크 / 시스템 테마, 팝업창·채팅창 폰트 크기, 라이브 채팅창 넓이, 팝업창·채팅창 배경색과 테두리, 팝업창 시간 표시, 채팅창 상단 배지 알림 효과를 원하는 방식으로 조정할 수 있습니다.

- **채팅창 요소 숨김**
  채팅창의 랭킹, 진행 중인 미션, 후원 메시지를 필요에 따라 숨길 수 있고, 팝업창에서는 방장·매니저·운영자·파트너 배지만 남기도록 설정할 수 있습니다.
